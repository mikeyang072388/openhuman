...
export default function ErrorFallbackScreen({
  ...
  const { t } = useT();
  const errorName = error instanceof Error ? error.name : t('errorFallback.errorNameDefault');
        ...
        <div className="p-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
            ...
            <button
              ...
              {t('errorFallback.downloadLatest')}
            </button>
          </div>
        </div>
      </div>
