  ...
  if (activity.length === 0) {
    return (
      <div className="space-y-3">
        <h3 className="text-lg font-semibold text-stone-900">{t('webhooks.activity.recentActivity')}</h3>
  ...
  return (
    <div className="space-y-3">
      <h3 className="text-lg font-semibold text-stone-900">
        {t('webhooks.activity.countLabel').replace('{count}', String(activity.length))}
      </h3>
