    ...
    <Dialog.Root open={open} onOpenChange={onOpenChange}>
      <Dialog.Portal>
        ...
        <Dialog.Content
          ...
          <Dialog.Title className="sr-only">{t('commands.palette')}</Dialog.Title>
          <Dialog.Description className="sr-only">
            {t('commands.paletteDesc')}
          </Dialog.Description>
          <Command label={t('commands.label')} shouldFilter={true}>
            <Command.Input
              autoFocus
