        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="max-h-[70vh] space-y-4 overflow-y-auto px-5 py-4">
            ...
            <div>
              ...
              />
              <p className="mt-1 text-[11px] text-stone-500">
                {t('skills.create.allowedToolsHint')}
              </p>
            </div>
            ...
            {error ? (
              <div
                ...
                <p className="font-semibold">{t('skills.create.errorTitle')}</p>
          ...
          <div className="flex items-center justify-end gap-2 border-t border-stone-100 px-5 py-3">
            ...
            <button
              ...
              {submitting ? t('skills.create.creating') : t('skills.create.submit')}
            </button>
          </div>
        </form>
      </div>
