...
const en: TranslationMap = {
  ...
  // Rewards: Referral
  'rewards.referral.title': 'Invite friends, earn credits',
  'rewards.referral.description':
    'Share your referral code. When a friend subscribes to a monthly plan, you both get $5 in account credit. Self-referrals and duplicate rewards are blocked on the server.',
  'rewards.referral.loading': 'Loading referral program…',
  'rewards.referral.yourCode': 'Your code',
  'rewards.referral.totalEarned': 'Total earned',
  'rewards.referral.pendingReferrals': 'Pending referrals',
  'rewards.referral.completed': 'Completed',
  'rewards.referral.copyFailed': 'Copy failed',
  'rewards.referral.haveCode': 'Have a referral code?',
  ...
  'rewards.referral.codePlaceholder': 'Referral code',
  'rewards.referral.applying': 'Applying…',
  'rewards.referral.apply': 'Apply',
  'rewards.referral.linkedToProgram': "You're linked to a referral program",
  'rewards.referral.activity': 'Referral activity',
  'rewards.referral.noReferrals': 'No referrals yet. Share your code to get started.',
  'rewards.referral.column.referredUser': 'Referred user',
  'rewards.referral.column.status': 'Status',
  'rewards.referral.column.reward': 'Reward',
  'rewards.referral.column.updated': 'Updated',
  'rewards.referral.status.completed': 'Completed',
  'rewards.referral.status.expired': 'Expired',
  'rewards.referral.status.joined': 'Joined',
  'rewards.referral.shareText': 'Join me on OpenHuman.',
  ...
  'rewards.coupon.redeemCode': 'Redeem Code',
  'rewards.coupon.recentRedemptions': 'Recent redemptions',
  'rewards.coupon.noRedemptions': 'No reward codes redeemed yet.',
  'rewards.coupon.loadingHistory': 'Loading reward history…',
  'rewards.coupon.column.code': 'Code',
  'rewards.coupon.column.reward': 'Reward',
  'rewards.coupon.column.status': 'Status',
  'rewards.coupon.column.redeemed': 'Redeemed',
  'rewards.coupon.status.applied': 'Applied',
  'rewards.coupon.status.pendingAction': 'Pending action',
  'rewards.coupon.status.redeemed': 'Redeemed',
  'rewards.coupon.status.pending': 'Pending',
  'rewards.coupon.loadError': 'Could not load reward codes right now.',
  'rewards.coupon.redeemError': 'Could not apply that reward code.',
  'rewards.coupon.accepted':
    '{code} accepted. {amount} will unlock after the required action is completed.',
  'rewards.coupon.redeemedMsg':
    '{code} redeemed. {amount} was added to your credits.',

  // Rewards: Community
  'rewards.community.title': 'Earn Rewards & Discord Roles',
  'rewards.community.description':
  ...
  'rewards.community.membership.waiting': 'Waiting for backend sync',
  'rewards.community.membership.joined': 'Joined the server',
  'rewards.community.membership.linkedNotInServer': 'Linked, but not in server',
  'rewards.community.membership.notLinked': 'Not linked',
  'rewards.community.membership.unavailable': 'Membership status unavailable',
  'rewards.community.error':
  ...
  'rewards.community.tryAgain': 'Try again',
  ...
  'usage.weeklyLimitHit': "You've hit your weekly limit.",
  'usage.rateLimitHit': "You've hit your 10-hour inference rate limit.",
  'usage.resets': 'It resets {time}.',
  'usage.upgradeToAvoid': 'Upgrade your plan or top up credits to avoid limits.',
  'usage.upgradeForHigher': 'Upgrade for higher limits.',
  'usage.planIncludes': '{name} plan includes:',
  'usage.per10HourWindow': '${amount} per 10-hour window',
  'usage.perWeekInference': '${amount}/week included inference',
  'usage.upgradePlan': 'Upgrade Plan',
  'usage.notNow': 'Not Now',
  'usage.now': 'now',
  'usage.inMinutes': 'in {n}m',
  'usage.inHours': 'in {n}h',
  'usage.inHoursMinutes': 'in {n}h {m}m',
  'usage.inDays': 'in {n}d',
  'usage.inDaysHours': 'in {n}d {h}h',

  // Upsell banner
  'upsell.reachedLimit': "You've reached your usage limit",
  'upsell.upgradeOrTopUp': 'Upgrade your plan or top up credits to continue',
  'upsell.approachingLimit': 'Approaching usage limit',
  'upsell.usedPercent': "You've used {pct}% of your usage limit. Upgrade for higher limits.",

  // Accounts: Respond Queue
  'accounts.respondQueuePanel.title': 'Respond queue',
  'accounts.respondQueuePanel.pending': '{count} pending',
  'accounts.respondQueuePanel.loadingQueue': 'Loading queue…',
  'accounts.respondQueuePanel.loadFailed': 'Failed to load respond queue',
  'accounts.respondQueuePanel.noEvents': 'No pending provider events yet.',
  'accounts.respondQueuePanel.unknownTime': 'unknown time',
  'accounts.respondQueuePanel.justNow': 'just now',
  'accounts.respondQueuePanel.minAgo': '{n}m ago',
  'accounts.respondQueuePanel.hrAgo': '{n}h ago',
  'accounts.respondQueuePanel.dayAgo': '{n}d ago',

  // Webhooks: Tunnels
  'webhooks.tunnels': 'Webhook Tunnels',
  'webhooks.newTunnel': '+ New Tunnel',
  'webhooks.tunnelNamePlaceholder': 'Tunnel name (e.g. telegram-bot)',
  'webhooks.descriptionOptional': 'Description (optional)',
  'webhooks.creating': 'Creating...',
  'webhooks.noTunnels': 'No tunnels yet. Create one to receive webhook events.',
  'webhooks.active': 'Active',
  'webhooks.inactive': 'Inactive',
  'webhooks.echo': 'Echo',
  'webhooks.resolvingBackendUrl': 'Resolving backend URL…',
  'webhooks.removeEcho': 'Remove Echo',
  'webhooks.enableEcho': 'Enable Echo',
  'webhooks.toggling': '...',
  'webhooks.failedCreateTunnel': 'Failed to create tunnel',
  'webhooks.failedDeleteTunnel': 'Failed to delete tunnel',
  'webhooks.failedToggleEcho': 'Failed to toggle echo',

  // Webhooks: Activity
  'webhooks.activity.recentActivity': 'Recent Activity',
  'webhooks.activity.empty':
    'No webhook activity yet. Events will appear here when webhooks are received.',
  'webhooks.activity.countLabel': 'Recent Activity ({count})',

  // Webhooks: ComposeIO
  'webhooks.composeio.title': 'ComposeIO Trigger History',
  'webhooks.composeio.empty': 'No ComposeIO triggers have been captured yet.',
  'webhooks.composeio.countLabel': 'ComposeIO Trigger History ({count})',
  'webhooks.composeio.metadataId': 'Metadata ID',
  'webhooks.composeio.metadataUuid': 'Metadata UUID',
  'webhooks.composeio.payload': 'Payload',

  // Commands
  'commands.palette': 'Command palette',
  'commands.paletteDesc':
    'Search and run commands. Use arrow keys to navigate, Enter to select, Escape to close.',
  'commands.searchPlaceholder': 'Type a command or search…',
  'commands.searchAria': 'Search commands',
  'commands.noResults': 'No results.',
  'commands.pressQuestionMark': 'Press ? for all shortcuts',
  'commands.label': 'Commands',

  // Walkthrough
  'walkthrough.back': 'Back',
  'walkthrough.next': 'Next →',
  'walkthrough.skipTour': 'Skip tour',
  'walkthrough.letsGo': "Let's go!",
  'walkthrough.of': 'of',
  'walkthrough.step1.title': 'Your command center',
  'walkthrough.step1.content':
    "This is your home base — a quick snapshot of what's happening and what needs your attention.",
  'walkthrough.step2.title': 'Say hello',
  'walkthrough.step2.content': 'Tap here to start a conversation with your AI assistant anytime.',
  'walkthrough.step3.title': 'Meet your AI',
  'walkthrough.step3.content':
    'This is where conversations happen. Ask questions, get summaries, or brainstorm. Everything stays searchable.',
  'walkthrough.step4.title': 'Connect your world',
  'walkthrough.step4.content':
    'Gmail, Slack, WhatsApp, and more — each connection gives your assistant superpowers.',
  'walkthrough.step5.title': 'Chat where you already are',
  'walkthrough.step5.content':
    'WhatsApp, Telegram, Slack, Discord — connect your messaging apps so your assistant can reach you anywhere.',
  'walkthrough.step6.title': "Your assistant's brain",
  'walkthrough.step6.content':
    'This is where your assistant learns and remembers. It gets smarter the more you use it.',
  'walkthrough.step7.title': 'Make it yours',
  'walkthrough.step7.content':
    'Preferences, privacy, notifications — everything is here. You can restart this tour anytime from this page.',
  'walkthrough.step8.title': 'Quick access',
  'walkthrough.step8.content': 'These tabs are your shortcuts — always one tap away.',
  'walkthrough.step9.title': 'Stay in the loop',
  'walkthrough.step9.content':
    'Alerts and automations live here — briefings, notifications, background activity.',
  'walkthrough.step10.title': "You're all set!",
  'walkthrough.step10.content':
  ...
  'settings.ai.loadingProviders': 'Loading…',
  'settings.ai.providerToggle.connect': 'Connect {provider}',
  'settings.ai.providerToggle.disconnect': 'Disconnect {provider}',
  ...
  'settings.ai.routingCustom': 'Custom',
  'settings.ai.routingDefaultChip': 'OpenHuman (default)',
  'settings.ai.routingDefaultResolves': 'Default resolves to',
  'settings.ai.routingChat': 'Chat',
  'settings.ai.routingBackground': 'Background',
  'settings.ai.customRoutingTitle': 'Custom routing',
  'settings.ai.customRoutingNoProviders':
    'No custom providers are set up yet. Add a cloud provider key above, or enable the local Ollama runtime, then come back to pick one.',
  'settings.ai.customRoutingProvider': 'Provider',
  'settings.ai.customRoutingModel': 'Model',
  'settings.ai.customRoutingModelPlaceholder': 'model id',
  'settings.ai.customRoutingLocalOllama': 'Local (Ollama)',
  'settings.ai.providerKey.title': 'Connect {provider}',
  'settings.ai.providerKey.description':
    "Paste your API key. It's stored encrypted on this device only.",
  'settings.ai.providerKey.apiKeyLabel': 'API key',
  'settings.ai.providerKey.placeholder': 'your-api-key',
  'settings.ai.providerKey.emptyError': 'Please paste your API key to continue.',
  'settings.ai.providerKey.saving': 'Saving…',
  'settings.ai.cloudProvider.editTitle': 'Edit {label}',
  'settings.ai.cloudProvider.addTitle': 'Add cloud provider',
  'settings.ai.cloudProvider.encryptionNote':
    'API keys are encrypted at rest in',
  'settings.ai.cloudProvider.providerSlug': 'Provider slug',
  'settings.ai.cloudProvider.displayLabel': 'Display label',
  'settings.ai.cloudProvider.displayLabelPlaceholder': 'My Provider',
  'settings.ai.cloudProvider.endpoint': 'Endpoint',
  'settings.ai.cloudProvider.endpointPlaceholder': 'https://api.example.com/v1',
  'settings.ai.cloudProvider.apiKey': 'API key',
  'settings.ai.cloudProvider.clearStoredKey': 'Clear stored key',
  'settings.ai.cloudProvider.keepExistingKey': 'Leave blank to keep existing key',
  'settings.ai.cloudProvider.saving': 'Saving…',
  'settings.ai.cloudProvider.saveChanges': 'Save changes',
  'settings.ai.cloudProvider.addProvider': 'Add provider',
  'settings.ai.failedToLoad': 'Failed to load AI settings',
  'settings.ai.failedToSave': 'Failed to save AI settings',
  ...
  'voice.sttProvider': 'Speech-to-Text Provider',
  'voice.sttProviderAria': 'STT provider',
  'voice.sttCloudOption': 'Cloud (Whisper proxy)',
  'voice.sttLocalOption': 'Local Whisper',
  'voice.sttLocalInstallRequired': ' (install required)',
  'voice.ttsProvider': 'Text-to-Speech Provider',
  'voice.ttsProviderAria': 'TTS provider',
  'voice.ttsCloudOption': 'Cloud (ElevenLabs proxy)',
  'voice.ttsLocalOption': 'Local Piper',
  'voice.ttsLocalInstallRequired': ' (install required)',
  'voice.whisperModel': 'Whisper Model',
  'voice.whisperModelAria': 'Whisper model',
  'voice.piperVoice': 'Piper Voice',
  'voice.piperVoiceAria': 'Piper voice',
  'voice.piperCustomOption': 'Other (type below)…',
  'voice.piperCustomAria': 'Piper voice id (custom)',
  ...
  'voice.whisperReinstallTitle': 'Whisper is installed. Click to reinstall.',
  'voice.piperInstallTitle':
    'Download Piper and the bundled en_US-lessac-medium voice into your workspace.',
  'voice.piperReinstallTitle': 'Piper is installed. Click to reinstall.',
  'voice.installed': 'Installed',
  'voice.notInstalled': 'Not installed',
  'voice.installFailed': 'Install failed',
  'voice.installLocally': 'Install locally',
  'voice.installing': 'Installing…',
  'voice.installingPct': 'Installing {pct}',
  'voice.reinstallLocally': 'Reinstall locally',
  'voice.repair': 'Repair',
  'voice.retryLocally': 'Retry locally',
  'voice.whisperReady': 'Whisper is ready.',
  'voice.whisperInstallStarted': 'Whisper install started ({stage})',
  'voice.failedToInstallWhisper': 'Failed to install Whisper',
  'voice.piperReady': 'Piper is ready.',
  'voice.piperInstallStarted': 'Piper install started ({stage})',
  'voice.failedToInstallPiper': 'Failed to install Piper',
  'voice.providersSaved': 'Voice providers saved.',
  'voice.failedToSaveProviders': 'Failed to save voice providers',
  'voice.failedToLoad': 'Failed to load voice settings',
  'voice.failedToSave': 'Failed to save voice settings',
  'voice.failedToStart': 'Failed to start voice server',
  'voice.failedToStop': 'Failed to stop voice server',
  ...
  'voice.mascotVoicePreset': 'Voice preset',
  'voice.mascotVoicePresetAria': 'Mascot voice preset',
  'voice.mascotCustomOption': 'Other (paste voice id)…',
  'voice.mascotCustomVoiceId': 'Custom voice id',
  'voice.mascotCustomVoiceIdAria': 'Custom ElevenLabs voice id',
  'voice.mascotCustomVoiceIdPlaceholder': 'e.g. 21m00Tcm4TlvDq8ikWAM',
