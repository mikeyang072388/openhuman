...
const Settings = () => {
  ...
  const accountSettingsItems = [
    {
      id: 'recovery-phrase',
      title: t('settings.account.recoveryPhrase'),
      description: t('settings.account.recoveryPhraseSectionDesc'),
    ...
    },
    {
      ...
      description: t('settings.account.teamSectionDesc'),
      route: 'team',
      icon: (
        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          <path
    ...
    },
    {
      ...
      description: t('settings.account.connectionsSectionDesc'),
      route: 'connections',
      icon: (
        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          <path
    ...
    },
    {
      ...
      description: t('settings.account.privacySectionDesc'),
      route: 'privacy',
      icon: (
        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          <path
  ...
  const featuresSettingsItems = [
    {
      ...
      description: t('settings.features.screenAwarenessSectionDesc'),
    ...
    {
      id: 'messaging',
      title: t('settings.features.messagingChannels'),
      description: t('settings.features.messagingChannelsSectionDesc'),
      route: 'messaging',
      icon: (
        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          <path
    ...
    },
    {
      ...
      description: t('settings.features.notificationsSectionDesc'),
      route: 'notifications',
      icon: (
        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          <path
    ...
    },
    {
      ...
      description: t('settings.features.toolsSectionDesc'),
      route: 'tools',
      icon: (
        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          <path
  ...
  const aiSettingsItems = [
    {
      ...
      description: t('settings.llmSectionDesc'),
      route: 'llm',
      icon: (
        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          <path
    ...
    {
      id: 'voice',
      title: t('settings.voiceSectionTitle'),
      description: t('settings.voiceSectionDesc'),
      route: 'voice',
      icon: (
        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          <path
        ...
        <Route
          ...
          element={wrapSettingsPage(
            <SettingsSectionPage
              ...
              description={t('settings.sectionAccountDesc')}
        ...
        <Route
          ...
          element={wrapSettingsPage(
            <SettingsSectionPage
              ...
              description={t('settings.sectionFeaturesDesc')}
